...
if(isset($_SESSION['ssUsername2']))
	{
		$username=$_SESSION['ssUsername2'];
...
//setcookie('password11014', '1234', time()+120, '/');
	...
	if ((isset($_COOKIE['username11014'])) && (isset($_COOKIE['password11014'])))
	{
		...
		if (($row['username']==$_COOKIE['username11014']) && ($row['password']==$_COOKIE['password11014'])) { 
			...
			$_SESSION['ssUsername2'] = $row['username'];
...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>jbmonster</title>
		<meta name="keywords" content="jbmonster" />
		<meta name="description" content="jbmonster">
	...
	<body class="loading-overlay-showing" data-loading-overlay>
		...
		<section class="body-sign">
			...
			<div class="center-sign">
				...
				<a href="http://www.jbmonster.com" class="logo pull-left">
