...
<html class="fixed ">
	<head>
		...
		<meta name="keywords" content="Compose Mail" />
		<meta name="description" content="Compose Mail">
...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Compose Mail</h2>
							</header>
							<div class="panel-body">
							<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="Add_compose.php" class="btn btn-primary" onclick="clicksound.playclip()">Add New <i class="fa fa-plus"></i></a>
...
<?php
//เลือกข้อมูล
$sql="SELECT * FROM compose ORDER BY id DESC ";
$result=mysql_query($sql)or die(mysql_error());
...
?>											
											...
											<td class="actions" style="font-size:15px;">
												...
												<a href="edit_compose.php?id=<?=$row['id']?>" style="font-size: 16px;" class="on-default "><i class="fa fa-cog"></i></a>
...
$('form#demo-form3').on('submit',function(e){
          ...
          if(id){           
            $.ajax({
              type: "POST",
              async: true,
              url: "process/compose/composeDelete.php",            
              data: "id="+id,
              dataType: "json",
