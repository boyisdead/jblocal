...
$sql2="SELECT * FROM webboard_post WHERE id = $id ";
...
<html class="fixed">
	<head>
		...
		<meta name="keywords" content="Edit New blog" />
		<meta name="description" content="Edit New blog">
							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Edit New blog</h2>
									</header>
									<div class="panel-body">
										
						
										
			<form class="form-horizontal" novalidate="novalidate" action="process/blog/postUpdate.php" method="post" enctype="multipart/form-data" name="product" >		
...
<input name="meid" type="hidden" id="id" value="<?=$iduser?>"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="subject" value="<?=$row2['subject']?>" id="subject" class="form-control" >
                </div>
            </div>

            <div class="form-group">
                <label for="subject" class="col-sm-2 control-label">Image</label>
                <div class="col-sm-10">
                    <img src="blog_image/<?=$row2['image']?>" class="img-responsive">
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="category_id" value="<?=$row2['email']?>" id="category_id" class="form-control" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <textarea  name="detail" rows="3" id="editor1" required=""><?=$row2['detail']?></textarea>
                    <input type="hidden" id="id" name="id" value="<?=base64_encode($row2['id'])?>">
                </div>
            </div>
