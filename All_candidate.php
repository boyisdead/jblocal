...
$sql="SELECT * FROM userDB2 WHERE owner1 = $admin_id";
$result=mysql_query($sql)or die(mysql_error());
...
$sqlc="SELECT * FROM user WHERE id = $admin_id ";
		$resultc=mysql_query($sqlc)or die(mysql_error());
...
?>
											...
											<td class="actions">
												<a href="owner_profile2.php?id=<?=base64_encode($row['id'])?>" title="Edit" onclick="clicksound.playclip()" style="font-size: 16px;" class="on-default "><i class="fa fa-play-circle-o "></i></a>
