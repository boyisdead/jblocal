...
<div class="col-lg-9">
    <div class="tab-content">
        <div id="login" style="margin:0px;">
            <div id="showalertrefer"></div>
            <h1 class="text-center" style="font-size: 18px; color:#666; font-weight: 100; margin-top: 0px;margin-bottom: 0px;"><?=$rowj['name']?></h1>
