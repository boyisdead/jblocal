...
VALUES('$ipaddress', '$country_user', \"$name\", $user_id, '$company', '$position', '$email', '$tel', '$image', '$dropbox', now() )";
...
echo"<script>$error;window.location='http://m.jbhired.com/success.html';</script>";
}
...
VALUES('$ipaddress', '$country_user', \"$name\", $user_id, '$company', '$position', '$email', '$tel', '$image', now() )";
mysql_query($sql)or die(mysql_error());
//คืนค่าไอดี
$product_id=mysql_insert_id();
//เพิ่มภาพหลัก
...
VALUES('$ipaddress', '$country_user', \"$name\", $user_id, '$company', '$position', '$email', '$tel', '$dropbox', now() )";
mysql_query($sql)or die(mysql_error());
//คืนค่าไอดี
$product_id=mysql_insert_id();
//เพิ่มภาพหลัก
                                                                            ...
                                                                            <table width='100%' align='center' cellspacing='0' cellpadding='0' border='0' class='full-width'>
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <h3>$name Your friend has sent infomation to you.</h3>
                                                                                       

                                                                                 <p>Please review the information. Now! <a href='http://www.jbhired.com/refer_links.php' target='_blank'>Refer Link process bar</a><p>
