...
<html class="fixed">
	<head>
		...
		<meta name="keywords" content="Candidate" />
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Candidate Data Info</h2>
							</header>
...
$sql="SELECT * FROM candidate_profile ";
$result=mysql_query($sql)or die(mysql_error());
...
?>
											...
											<td class="actions">
												<a href="candidate_profile.php?cus_id=<?=$row['id']?>" onclick="clicksound.playclip()" style="font-size: 16px;" class="on-default "><i class="fa fa-play-circle"></i></a>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/cusDelete.php?id=<?=base64_encode($row['id'])?>">Confirm</a>
