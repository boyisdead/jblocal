...
$sqlp="SELECT * FROM insurance_al WHERE id = $action_id";
			...
			<header class="clearfix">
									<div class="row">
										<div class="col-sm-6 mt-md">
											<h2 class="h2 mt-none mb-sm text-dark text-weight-bold">ประกันวินาศภัย</h2>
...
$sqlp="SELECT * FROM insurance_al WHERE customer_id = $customer_id";
$resultp=mysql_query($sqlp)or die(mysql_error());
for($i=0;$rowp=mysql_fetch_assoc($resultp);$i++){ 


	$time = strtotime($rowp['inal_startDate']);
    $my_formatf1 = date("d/m/Y", $time);


    $time2 = strtotime($rowp['endDate']);
    $my_formatf2 = date("d/m/Y", $time2);



        $time3 = strtotime($rowp['inal_deal']);
    $my_formatf3 = date("d/m/Y", $time3);


        $time4 = strtotime($rowp['confirmPay']);
									...
									<table class="table ">
										...
										<tbody style="font-size:10px;">
											...
											<tr>
												...
												<td style="padding: 4px;"><?=$rowp['inal_nameCompany']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">เลขที่กรมธรรม์</td>
												<td style="padding: 4px;"><?=$rowp['inal_no']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">ชื่อผุ้เอาประกัน กรณี แตกต่างจากเจ้าของบัญชี</td>
												<td style="padding: 4px;"><?=$rowp['inal_anotherRec']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">ประเภทของประกัน</td>
												<td style="padding: 4px;"><?=$rowp['inal_type']?> </td>
											</tr>

											<tr>
												<td style="padding: 4px;">ทุนประกัน</td>
												<td style="padding: 4px;"><?=number_format($rowp['toon_money'])?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">ชื่อชนิดประกัน</td>
												<td style="padding: 4px;"><?=$rowp['inal_nameType']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">Broker</td>
												<td style="padding: 4px;"><?=$rowp['inal_contact']?></td>
											</tr>
											...
											<tr>
												...
												<td style="padding: 4px;"><?=number_format($rowp['inal_moneyPay'])?></td>
											</tr>
											...
											<tr>
												...
												<td style="padding: 4px;"><?=$rowp['inal_whoRec']?></td>
											</tr>
											...
											<tr>
												...
												<td style="padding: 4px;"><?=$rowp['inal_status']?></td>
											</tr>

											
											<tr>
												<td style="padding: 4px;">หมายเหตุ </td>
												<td style="padding: 4px;"><?=$rowp['inal_rematk']?></td>
											</tr>
