...
$sqlp="SELECT * FROM private_fund WHERE id = $action_id";
...
$sqlp="SELECT * FROM private_fund WHERE customer_id = $customer_id";
$resultp=mysql_query($sqlp)or die(mysql_error());
for($i=0;$rowp=mysql_fetch_assoc($resultp);$i++){ 


	$time = strtotime($rowp['start_date']);
			...
			<div class="table-responsive">
									<table class="table ">
										...
										<tbody style="font-size:10px;">
											...
											<tr>
												<td style="padding: 4px;">ชื่อบริษัทหลักทรัพย์</td>
												<td style="padding: 4px;"><?=$rowp['private_broker']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">หมายเลขบัญชี</td>
												<td style="padding: 4px;"><?=$rowp['private_no']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">วันที่เริ่มลงทุน</td>
												<td style="padding: 4px;"><?=$my_format1?> </td>
											</tr>

											<tr>
												<td style="padding: 4px;">จำนวนเงินลงทุนเริ่มต้น (บาท)</td>
												<td style="padding: 4px;"><?=number_format($rowp['start_money'])?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">บัญชีธนาคารที่ผูก</td>
												<td style="padding: 4px;"><?=$rowp['banklink']?></td>
											</tr>

											<tr>
												<td style="padding: 4px;">ลักษณะการลงทุน</td>
												<td style="padding: 4px;"><?=$rowp['private_style']?></td>
											</tr>
											...
											<tr>
												...
												<td style="padding: 4px;"><?=$rowp['private_remark']?></td>
											</tr>
