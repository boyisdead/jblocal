...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Hot Jobs</h2>
							</header>
...
?>											
											...
											<td class="actions" style="font-size:15px;">
												...
												<a href="edit_hot_job.php?id=<?=base64_encode($row['id'])?>" style="font-size: 16px;" class="on-default "><i class="fa fa-cog"></i></a>
