<?php
	...
	if($num!=0){
		...
		if(isset($rowu['cv']) && $rowu['cv'] != "") {

			$arr1 = array('status' =>1001, "msg" => "cv is ready.", "cv" => $rowu['cv']);
			...
			$arr2 = array('status' =>1002, "msg" => "cv does not exist.");
	    ...
	    $arr3 = array('status' =>1003, "msg" => "user doesn't exist.");
