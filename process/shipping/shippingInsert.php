...
if($num!=0){echo"<script>alert('Duplicate Job Apply');history.back();</script>";}
                                                                            ...
                                                                            <table align='center' cellspacing='0' cellpadding='0' border='0' class='full-width' width='100%''>
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <a href='www.jbhired.com' style='color:#ffffff;text-decoration:none !important; '>www.jbhired.com</a>
                                                                                        </td>
                                                                                    </tr>                                                                           
...
try {
 ...
 echo"<script>window.location='../../../user-job-apply.php';</script>";exit; 

} else {

	echo"<script>alert('Data duplication job');history.back();</script>";
}
