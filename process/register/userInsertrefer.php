...
$chkIsNewLetter=$_REQUEST['chkIsNewLetter'];

$password2 = md5($password);
$avatar="http://www.jbhired.com/admin/cusimage/default-avatar.png";
	...
	$row=mysql_fetch_assoc($result);
				...
				if($row['COUNT(*)']==0){
					...
					$token = random_string(50);
							...
							$sql="INSERT INTO candidate_profile(file_name, email, name, overall_experience, create_date, oauth_provider, password, accept) 
							VALUES(\"$avatar\", '$email', '$username', '$token', now(), 'email', '$password2', '$chkIsNewLetter' )";
							mysql_query($sql)or die(mysql_error());

                            $product_id=mysql_insert_id();


                            $sql="INSERT INTO refer_rf(user_id, refer_to, insert_date) 
                            VALUES($refer, $product_id, now() )";
                            mysql_query($sql)or die(mysql_error());
                                                                            ...
                                                                            <table width='100%' align='center' cellspacing='0' cellpadding='0' border='0' class='full-width'>
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        Verify your Email for jbhired</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        Verify your Email for jbhired<br>
                                                                                        The jbhired account with username $email <br>
                                                                                        click the following link: <a href='http://jbhired.com/tackingupload.php?email=$email&token=$token'>http://jbhired.com/tackingupload.php?email=$email&token=$token</a><br>
...
try {
    ...
    $message = array(
        ...
        'from_name' => 'JBhired verify email',
        'to' => array(
            array(
                'email' => $email,
                'name' => $username,
