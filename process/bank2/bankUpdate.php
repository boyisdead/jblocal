...
$sql="UPDATE refer_email SET job_id=$jobid, jb_approve=\"$jb_approve\", company_approve=\"$company_approve\", offer_mode=\"$offer_mode\", company_hire=\"$company_hire\", start_date='$start_date', probation_date='$probation_date', status='$status', last_update=now() WHERE id=$id";
mysql_query($sql)or die(mysql_error());

$sql="INSERT INTO noti(title, detail, user_id, link, insert_date) VALUES('$title', '$detail', $user_id, '$link', now())";
mysql_query($sql)or die(mysql_error());
