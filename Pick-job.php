...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Pick Jobs</h2>
							</header>
...
<?php
//เลือกข้อมูล
$sql="SELECT * FROM job_post WHERE status=2 ORDER BY id DESC ";
$result=mysql_query($sql)or die(mysql_error());
...
?>											
											...
											<td class="actions" style="font-size:15px;">
												...
												<a href="edit_pick_job.php?id=<?=base64_encode($row['id'])?>" style="font-size: 16px;" class="on-default "><i class="fa fa-cog"></i></a>
