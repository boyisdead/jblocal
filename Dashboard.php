...
?>
													...
													<div class="summary-footer">
														<a href="http://www.jbhired.com/admin/job-refer.php" class="text-muted text-uppercase">(view all)</a>
													</div>
												</div>
											</div>
										</div>
...
?>
													...
													<div class="summary-footer">
														<a href="http://www.jbhired.com/admin/job-ap.php" class="text-muted text-uppercase">(view all)</a>
													</div>
												</div>
											</div>
										</div>
...
?>
													...
													<div class="summary-footer">
														<a href="http://www.jbhired.com/admin/candidate.php" class="text-muted text-uppercase">(report)</a>
													</div>
												</div>
											</div>
										</div>
...
?>
														...
														<?php
$sql="SELECT COUNT(*) FROM job_post WHERE status2 = 0 ";
$result=mysql_query($sql)or die(mysql_error());
$row=mysql_fetch_array($result);
$num=$row['COUNT(*)'];
$numAll=$num;
?>
															...
															<span class="text-primary">(live <?=$numAll?> jobs)</span>
														</div>
													</div>
													<div class="summary-footer">
														<a href="http://www.jbhired.com/admin/job.php" class="text-muted text-uppercase">(view now)</a>
													</div>
												</div>
											</div>
										</div>
...
<div class="row">
							<div class="col-lg-12">
								<section class="panel">
									...
									<form class="form-horizontal form-bordered" action="Dashboard_search.php" method="post">
									<div class="panel-body">
...
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
	...
	?>
											...
											?>
													<td>
														<a target="_blank" href="upload_view.php"><i class="fa fa-search"></i> view</a>
													</td>
												</tr>
<?php
}
