					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>CateEmployeegory</span></li>
							</ol>
...
<section class="panel">
							...
							<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="#modalAnim-2002" class="modal-with-zoom-anim btn btn-primary" onclick="clicksound.playclip()">Add Employee <i class="fa fa-plus"></i></a>
											<div id="modalAnim-2002" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form1" class="form-horizontal mb-lg"  action="process/employee/employeeInsert.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
									...
									<div id="showalert"></div>
								                    ...
								                    <div class="form-group">
								                        ...
								                        <div class="col-sm-6">
								                            <input type="text" name="password" readonly="readonly" value="12345" class="form-control" >
								                        </div>
								                    </div>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<button type="submit" class="btn btn-primary " onclick="clicksound.playclip()">Add data</button>
...
?>
											<td><?=$row['id']?></td>
                                            <td><a target="_blank" href="Dashboard3.php?id=<?=$row['id']?>"><img src="avatar/<?=$row['Image']?>" alt="<?=$row['username']?>" style="height:45px;" class="img-circle"> <?=$row['username']?></a></td>
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<form id="demo-form3" class="form-horizontal mb-lg"  action="process/employee/employeeDelete.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
											...
											<div class="panel-body">
												...
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<p>You will Delete this Employee <b style="color:red"><?=$row['username']?></b> ?</p>
													</div>
													<div class="form-group">
								                       
								                        <div class="col-sm-7">
								                            <input type="text" name="security"  id="security" class="form-control" placeholder="Security password" required>
								                       </div>
								                    </div>
												</div>
											</div>
...
<div id="modalAnim3<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form2" class="form-horizontal mb-lg"  action="process/employee/employeeUpdate.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Edit Employee <?=$row['username']?> ?</h2>
											</header>
											<div class="panel-body">
									<div id="showalert1"></div>
										...
										<input name="id" type="hidden" id="id" value="<?=base64_encode($row['id'])?>"/>
													...
													<div class="form-group">
								                        ...
								                        <div class="col-sm-7">
								                            <input type="text" name="username" value="<?=$row['username']?>" id="username" class="form-control" required>
								                        </div>
								                    </div>
								                    ...
								                    <div class="form-group">
								                        ...
								                        <div class="col-sm-7">
								                            <input type="text" name="password" value="<?=$row['password']?>" id="password" class="form-control" required>
								                        </div>
								                    </div>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<button type="submit" class="btn btn-primary " onclick="clicksound.playclip()">Edit</button>
														<button class="btn btn-default modal-dismiss">Cancel</button>
													</div>
												</div>
											</footer>
