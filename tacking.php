...
<html class="fixed">
	<head>
		...
		<title>Tacking</title>
		<meta name="keywords" content="Tacking" />
		<meta name="description" content="Tacking">
						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li>
										<a href="tacking.php" onclick="clicksound.playclip()">
...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Tacking</h2>
							</header>
...
<?php
//เลือกข้อมูล
$sql="SELECT * FROM refer_rf ORDER BY id";
$result=mysql_query($sql)or die(mysql_error());
...
$sqlr="SELECT * FROM candidate_profile WHERE id = $row[user_id]";
$resultr=mysql_query($sqlr)or die(mysql_error());
$rowr=mysql_fetch_assoc($resultr);


$sqlrt="SELECT * FROM candidate_profile WHERE id = $row[refer_to] ";
$resultrt=mysql_query($sqlrt)or die(mysql_error());
...
?>
											<td><?=$row['id']?></td>
                                            <td><a href="candidate_profile.php?cus_id=<?=$rowr['id']?>" target="_blank"><?=$rowr['name']?></a> Refer 
                                            	<i class="fa fa-share"></i> <a href="candidate_profile.php?cus_id=<?=$rowrt['id']?>" target="_blank"><?=$rowrt['name']?></a></td>
											
											
											<td><a href="cv/<?=$rowrt['cv']?>" target="_blank">CV File</a></td>
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<form id="demo-form3" class="form-horizontal mb-lg"  action="process/" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
											...
											<div class="panel-body">
												...
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<p>You will Delete this Blog <b style="color:red"><?=$row['name']?></b> ?</p>
													</div>
												</div>
											</div>
