...
<section class="panel">
							...
							<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="Add_blog.php" class=" btn btn-primary" onclick="clicksound.playclip()">Add blog <i class="fa fa-plus"></i></a>
...
<?php
//เลือกข้อมูล
$sql="SELECT * FROM webboard_post WHERE id!=0 ORDER BY id";
$result=mysql_query($sql)or die(mysql_error());
...
?>
											...
											<td class="actions" style="font-size:15px;">
												...
												<a href="blog-edit.php?id=<?=base64_encode($row['id'])?>" style="font-size: 16px;" class="on-default "><i class="fa fa-cog"></i></a>
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<form id="demo-form3" class="form-horizontal mb-lg"  action="process/blog/postDelete.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
...
$('form#demo-form3').on('submit',function(e){
          ...
          if(id){           
            $.ajax({
              type: "POST",
              async: true,
              url: "process/blog/postDelete.php",            
              data: "id="+id,
              dataType: "json",
