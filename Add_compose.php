...
<html class="fixed">
	<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Add Compose Mail</title>
		<meta name="keywords" content="Add Compose Mail" />
		<meta name="description" content="Add Compose Mail">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Add Compose Mail</span></li>
							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add Compose Mail</h2>
									</header>
									<div class="panel-body">
										
						
										
			<form class="form-horizontal" novalidate="novalidate" action="process/compose/productInsert.php" method="post" enctype="multipart/form-data" name="product" >		
          ...
          <label class="col-sm-2 control-label" for="user_email">Enter mail subject.</label>
           <div class="col-sm-10">
            <span class="typeahead-query">
                <input  type="text" class="form-control" id="subject" name="subject" placeholder="Enter mail subject.">
            </span>
          </div>
        </div>
...
<hr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <textarea id="lawsContent" name="detail" class="form-control hide"></textarea>
                </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="no" class="col-sm-2 control-label">Job id</label>
                <div class="col-sm-10">
