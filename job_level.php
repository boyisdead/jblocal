...
<html class="fixed">
	<head>
		...
		<meta name="keywords" content="Job level" />
		<meta name="description" content="Job level">
...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Job level</h2>
							</header>
							<div class="panel-body">
							<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="#modalAnim-2002" class="modal-with-zoom-anim btn btn-primary" onclick="clicksound.playclip()">Add Job level <i class="fa fa-plus"></i></a>
											<div id="modalAnim-2002" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form1" class="form-horizontal mb-lg"  action="process/job_level/categoryInsert.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Add new Job level</h2>
											</header>
											<div class="panel-body">
									<div id="showalert"></div>
													...
													<div class="form-group">
								                        <label for="name" class="col-sm-3 control-label">Job level Name</label>
								                        <div class="col-sm-7">
...
<?php
//เลือกข้อมูล
$sql="SELECT * FROM job_level WHERE id!=0 ORDER BY name";
$result=mysql_query($sql)or die(mysql_error());
...
$sqln="SELECT job_level FROM job_post WHERE job_level=$row[id] ";
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<form id="demo-form3" class="form-horizontal mb-lg"  action="process/job_level/categoryDelete.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
											...
											<div class="panel-body">
												...
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<p>You will Delete this Job level <b style="color:red"><?=$row['name']?></b> ?</p>
													</div>
												</div>
											</div>
											<footer class="panel-footer">
...
<div id="modalAnim3<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form2" class="form-horizontal mb-lg"  action="process/job_level/categoryUpdate.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Edit Job level <?=$row['name']?> ?</h2>
											</header>
											<div class="panel-body">
									<div id="showalert1"></div>
										...
										<input name="id" type="hidden" id="id" value="<?=base64_encode($row['id'])?>"/>
													...
													<div class="form-group">
								                        ...
								                        <div class="col-sm-7">
								                            <input type="text" name="category" value="<?=$row['name']?>" id="name" class="form-control" required>
								                        </div>
								                    </div>
								                    ...
								                    <div class="form-group">
								                        ...
								                        <div class="col-sm-7">
								                            <img src="cusimage/<?=$row['image']?>" class="img-responsive" height="250">
								                        </div>
								                    </div>
...
$('form#demo-form3').on('submit',function(e){
          ...
          if(id){           
            $.ajax({
              type: "POST",
              async: true,
              url: "process/job_level/categoryDelete.php",            
              data: "id="+id,
              dataType: "json",
