...
<section class="panel">
							...
							<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="#modalAnim-2002" class="modal-with-zoom-anim btn btn-primary" onclick="clicksound.playclip()">Add Category <i class="fa fa-plus"></i></a>
											<div id="modalAnim-2002" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form1" class="form-horizontal mb-lg"  action="process/category/categoryInsert.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
...
$sqla="SELECT * FROM job_post WHERE department = $row[id] ";
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<form id="demo-form3" class="form-horizontal mb-lg"  action="server/action.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
											...
											<div class="panel-body">
												...
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<p>You will Delete this Category <b style="color:red"><?=$row['name']?></b> ?</p>
													</div>
												</div>
											</div>
											<footer class="panel-footer">
...
<div id="modalAnim3<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form2" class="form-horizontal mb-lg"  action="process/category/categoryUpdate.php" method="post" enctype="multipart/form-data">
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Edit Category <?=$row['name']?> ?</h2>
											</header>
											<div class="panel-body">
...
$('form#demo-form3').on('submit',function(e){
          ...
          if(id){           
            $.ajax({
              type: "POST",
              async: true,
              url: "process/category/categoryDelete.php",            
              data: "id="+id,
              dataType: "json",
