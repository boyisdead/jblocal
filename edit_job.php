            ...
            <div class="panel-body">
                ...
                <div class="widget-toggle-expand mb-md widget-collapsed">
                    <div class="widget-header">
                        ...
                        <br>
                        <p><b><a TARGET='_blank' href="pdf/<?=$row2['file_name']?>">
	                        <i class="fa fa-file-pdf-o"></i> Job Description 
                        </a></b></p>
                    </div>
                </div>
                <div class="clearfix">
            ...
            <div class="tab-content">
                <div id="edit" class="tab-pane active">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"><b>Nationalities :</b></label>
                            <div class="col-md-8">
                                <label class="">
                                    <?=$row2['nationalities']?>
                                </label>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"><b>summary :</b></label>
                            <div class="col-md-8">
                                <label class="control-label">
                                    <?=$row2['summary']?>
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <label class="control-label">
                                    <?=number_format($row2['refer_bonus'])?>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
...
?>
                ...
                <div id="pass" class="tab-pane">
                    ...
                    <form class="form-horizontal" action="process/product/productUpdate.php" method="post" enctype="multipart/form-data" name="product">
                        <!-- P2 -->
                        <fieldset>
...
?>
						                    <option value="<?=$rowCategory['id']?>" <?php if($row2[ 'department']==$rowCategory[ 'id']){echo "selected='selected'";}?>>
						                        <?=$rowCategory['name']?>
						                    </option>
<?php
    }
...
<?php
	...
	for($i=1;$i<=$numCategory;$i++){$rowCategory=mysql_fetch_array($resultCategory); 
?>
						                    <option value="<?=$rowCategory['id']?>" <?php if($row2[ 'job_level']==$rowCategory[ 'id']){echo "selected='selected'";}?>>
						                        <?=$rowCategory['name']?>
						                    </option>
<?php
	}
?>
						    ...
						    <div class="typeahead-container form-group ">
						        ...
						        <div class="col-sm-7">
						            <span class="typeahead-query">
						                <input  type="text" class="form-control" id="nationalities" name="nationalities" value="<?=$row2['nationalities']?>">
						            </span>
						        </div>
						    </div>
						    <div class="typeahead-container form-group ">
						    ...
						    <div class="form-group">
						        ...
						        <div class="col-sm-7">
						            <textarea name="Address" id="Address" style="height:300px;" class="form-control">
						                <?=$row2['address']?>
						            </textarea>
						        </div>
						    </div>
						    <div class="form-group">
						        ...
						        <div class="col-sm-7">
						            <textarea name="Description" id="detail" style="height:300px;" class="form-control">
						                <?=$row2['description']?>
						            </textarea>
						        </div>
						    </div>
						    <div class="form-group">
						        ...
						        <div class="col-sm-7">
						            <textarea name="summary" id="summary" rows="3" class="form-control">
						                <?=$row2['summary']?>
						            </textarea>
						        </div>
						    </div>
