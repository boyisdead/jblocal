...
$resultss=mysql_query($sqls)or die(mysql_error());
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Customer of Guest</h2>
							</header>
...
//หาจำนวนหน้า
$sql="SELECT COUNT(*) FROM customer WHERE member_id = $id ";
$result=mysql_query($sql)or die(mysql_error());
...
//เลือกข้อมูล
$sql="SELECT * FROM customer WHERE member_id = $id ORDER BY customer.id ASC LIMIT $start_record, $page_size";
$result=mysql_query($sql)or die(mysql_error());
