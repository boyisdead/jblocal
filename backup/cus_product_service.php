...
$time = strtotime($row2['pa_policy_date']);
    ...
    $time2 = strtotime($row2['endl_date_service']);
    $my_formata = date("Y", $time2);
    $my_formata1 = date("F", $time2);
    $my_formata2 = date("d", $time2);


        $time3 = strtotime($row2['pa_pay_date']);
    $my_formatb = date("Y", $time3);
    $my_formatb1 = date("F", $time3);
    $my_formatb2 = date("d", $time3);

        $time4 = strtotime($row2['last_money']);
    $my_formatc = date("Y", $time4);
    $my_formatc1 = date("F", $time4);
    $my_formatc2 = date("d", $time4);
									...
									<div class="panel-body bg-tertiary" style="margin-bottom:10px;">
										<div class="widget-summary widget-summary-sm">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4 class="title"><?=$rowMF['product']?>. ( <?=$i+1?> ) <a href="#modalAnim<?=$rowMF['id']?>" class="modal-with-zoom-anim" style="float:right; color:#fff; font-size:18px"><i class="fa fa-trash-o"></i></a></h4>
													<div class="info">
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/ProDelete.php?id=<?=$rowMF['id']?>">Confirm</a>
								...
								<div class="tab-content">
									...
									<div id="edit" class="tab-pane active">
											...
											<fieldset>
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b>หมายเลขกรมธรรม์ :</b></label>
													<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b>จำนวนเบี้ยลงทุน  :</b></label>
													<div class="col-md-6">
														<label class="" ><?=number_format($row2['money_to_m'])?></label>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-5 control-label" ><b>สกุลเงินที่ลงทุน  :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$row2['pa_currency']?></label>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-5 control-label" ><b>จำนวนเบี้ยเริ่มต้น (บาท)  :</b></label>
													<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><code><b>จำนวนเบี้ยที่จ่ายล่าสุด (บาท)  :</b></code></label>
													<div class="col-md-6">
														<label class="" ><?=number_format($row2['pa_type'])?></label>
													</div>
												</div>


												<div class="form-group">
													<label class="col-md-5 control-label" ><b>จำนวนปีที่จ่ายเบี้ย(ปี)  :</b></label>
													<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b>จำนวนปีที่ทำสัญญา(ปี)  :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$row2['pa_all_year']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><?=$my_formata2?> <?=$my_formata1?> <?=$my_formata?></label>
													</div>
												</div>


												<div class="form-group">
													<label class="col-md-5 control-label" ><b>วันที่ดิวเบี้ย :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$my_formatb2?> <?=$my_formatb1?> <?=$my_formatb?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><?=$my_formatc2?> <?=$my_formatc1?> <?=$my_formatc?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['detail_for_bear']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>จำนวนเงินที่ได้รับคืนต่อปี :</b></label>
													<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>จำนวนทุนประกัน :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['pa_money_reverse']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>ชื่อผู้รับผลประโยชน์ :</b></label>
													<div class="col-md-6">
...
<hr>
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>Broker Login Name :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['pa_grandtag_name']?></label>
													</div>
												</div>


												<div class="form-group">
													<label class="col-md-5 control-label"><b>Broker Password :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['pa_gandtag_pwd']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>Website Product :</b></label>
													<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>Product Login :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['pa_login_name']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>Product Password :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['pa_login_pwd']?></label>
													</div>
												</div>
...
<form class="form-horizontal" action="server/ProductServiceUpdate.php" method="post" enctype="multipart/form-data" name="product" >
	...
	<input name="cus_id" type="hidden" id="id" value="<?=$customer_id?>"/>
            ...
            <div class="form-group">
                <label for="policy_no" class="col-sm-4 control-label">หมายเลขกรมธรรม์</label>
                <div class="col-sm-7">
                	<input type="text" name="policy_no" id="policy_no" value="<?=$row2['policy_no']?>" class="form-control">
                    
                </div>
            </div>

            <div class="form-group">
                <label for="money_to_m" class="col-sm-4 control-label">จำนวนเบี้ยลงทุน</label>
                <div class="col-sm-7">
                	<input type="text" name="money_to_m" id="money_to_m" value="<?=$row2['money_to_m']?>" class="form-control">
                    
                </div>
            </div>	

            <div class="form-group">
                <label for="broker" class="col-sm-4 control-label">สกุลเงินที่ลงทุน</label>
                <div class="col-sm-7">
                    <select name="currency" id="broker" class="form-control">
                    	<option value="<?=$row2['pa_currency']?>"><?=$row2['pa_currency']?></option>
                    	<?php
                        $sqlcus="SELECT * FROM product2 WHERE category_id = 5 ORDER BY id ASC ";
						$resultcus=mysql_query($sqlcus)or die(mysql_error());
						for($icus=0;$rowcus=mysql_fetch_assoc($resultcus);$icus++){ 
						?>
                   		<option value="<?=$rowcus['name']?>"><?=$rowcus['name']?></option>
            ...
            <div class="form-group">
                <label for="first_money" class="col-sm-4 control-label">จำนวนเบี้ยเริ่มต้น (บาท) </label>
                <div class="col-sm-7">
                	<input type="text" name="first_money" id="first_money" value="<?=$row2['first_money']?>" class="form-control">
			...
			<div class="form-group">
                <label for="last_money_to_m" class="col-sm-4 control-label"><code><b>จำนวนเบี้ยที่จ่ายล่าสุด (บาท) </b></code></label>
             
                <div class="col-sm-7">
                	<input type="text" name="last_money_to_m" id="last_money_to_m" value="<?=$row2['pa_type']?>" class="form-control">
            ...
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">จำนวนปีที่จ่ายเบี้ย(ปี)</label>
                <div class="col-sm-7">
                	<input type="text" name="count_year" id="startMoney" value="<?=$row2['pa_count_year']?>" class="form-control">
            ...
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">จำนวนปีที่ทำสัญญา(ปี)</label>
                <div class="col-sm-7">
                	<input type="text" name="all_year" id="startMoney" value="<?=$row2['pa_all_year']?>" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group date">
                        <input id="birthday" name="date_for_start" value="<?=$row2['pa_policy_date']?>" class="form-control" type="text">
  ...
  <!-- ////////////////////////////////////////////////////// //////////////////////////////////////////////////////////////////////////  ////////////////// -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group date">
                        <input id="birthday" name="endl_date_service" value="<?=$row2['endl_date_service']?>" class="form-control" type="text">
                        <span class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                        </span>
                    </div>
            ...
            <div class="form-group">
                <label for="startDate" class="col-sm-4 control-label">วันที่ดิวเบี้ย</label>
                <div class="col-sm-7">
                    <div class="input-group date">
            ...
            <div class="form-group">
                <label for="detail_for_bear" class="col-sm-4 control-label">รายละเอียดการจ่ายเบี้ย</label>
                <div class="col-sm-7">
                	<input type="text" name="detail_for_bear" value="<?=$row2['detail_for_bear']?>" id="detail_for_bear" class="form-control">
                    
                </div>
            </div>

            <div class="form-group">
                <label for="some_year" class="col-sm-4 control-label">จำนวนปีที่จ่ายเบี้ย</label>
                <div class="col-sm-7">
                	<input type="text" name="some_year" id="some_year" value="<?=$row2['pa_amount_per_year']?>" class="form-control">
                    
                </div>
            </div>

            <div class="form-group">
                <label for="detail_for_recive" class="col-sm-4 control-label">รายละเอียดการรับเงิน</label>
                <div class="col-sm-7">
                	<input type="text" name="detail_for_recive" value="<?=$row2['pa_how_to_pay']?>" id="detail_for_recive" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                	<input type="text" name="money_reverse" value="<?=$row2['pa_money_pay']?>" id="startMoney" class="form-control">
            ...
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">จำนวนทุนประกัน</label>
                <div class="col-sm-7">
                	<input type="text" name="total_money_reverse" value="<?=$row2['pa_money_reverse']?>" id="startMoney" class="form-control">
                    
                </div>
            </div>

            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">ชื่อผู้รับผลประโยชน์</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label for="no" class="col-sm-4 control-label">Broker Login Name</label>
                <div class="col-sm-7">
                    <input type="text" name="pa_grandtag_name" value="<?=$row2['pa_grandtag_name']?>" id="no" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="startMoney" class="col-sm-4 control-label">Broker Password</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">Website Product</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">Product Login</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">Product Password</label>
                <div class="col-sm-7">
