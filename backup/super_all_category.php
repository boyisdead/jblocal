							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									...
									<div class="col-sm-6">
										...
										<input name="action" type="hidden" id="id" value="add_category2"/>

									            	<div class="form-group">
                        <label for="namecat" class="col-sm-4 control-label">ชื่อหมวดหมู่</label>
                        <div class="col-sm-7">
                            <input type="text" name="namecat" id="namecat" class="form-control">
                        </div>
                    </div>
...
?>
										...
										<tr>
											<td><?=$row['name']?></td>
											<td><?php
$sqlNumProduct="SELECT COUNT(*) AS num_product FROM product2 WHERE category_id=$row[id]";
...
?></td>
											...
											<td class="actions" style="font-size:15px;">
												...
												<a href="category_all_Product.php?id=<?=$row['id']?>" style="font-size: 16px;" class="on-default " onclick="clicksound.playclip()"><i class="fa fa-play-circle"></i></a>
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/super.php?id=<?=$row['id']?>&action=del_category2">Confirm</a>
														<button class="btn btn-default modal-dismiss">Cancel</button>
													</div>
												</div>
											</footer>
									...
									<div id="modalAnim3<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										...
										<section class="panel">
											<header class="panel-heading">
												<h2 class="panel-title">Edit your Category ?</h2>
											</header>
											<div class="panel-body">
									
										<input name="action" type="hidden" id="id" value="update_category2"/>
                    ...
                    <div class="form-group">
                        <label for="namecat" class="col-sm-4 control-label">ชื่อหมวดหมู่</label>
                        <div class="col-sm-7">
                            <input type="text" name="namecat" id="namecat" value="<?=$row['name']?>" class="form-control">
                        </div>
                    </div>
