...
<html class="fixed">
	<head>
		...
		<meta name="keywords" content="Add Mutual Fund" />
		<meta name="description" content="Add Mutual Fund">
							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add New Mutual Fund</h2>
									</header>
									<div class="panel-body">
										
						
										
			<form class="form-horizontal" novalidate="novalidate" action="server/insert_MF.php" method="post" enctype="multipart/form-data" name="product" >		
...
?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <select name="product_mf" id="broker" class="form-control" >
            ...
            <div class="form-group">
                <label for="LoginPhill" class="col-sm-4 control-label">Login</label>
                <div class="col-sm-7">
                    <input type="text" name="LoginPhill" id="LoginPhill" class="form-control" >
                </div>
            </div>
            <div class="form-group">
                <label for="PwdPhill" class="col-sm-4 control-label">Password</label>
                <div class="col-sm-7">
                    <input type="text" name="PwdPhill" id="PwdPhill" class="form-control" >
                </div>
            </div>
            <div class="form-group">
                <label for="goalLTF" class="col-sm-4 control-label">Goal LTF/Year</label>
                <div class="col-sm-7">
                    <input type="text" name="goalLTF" id="goalLTF" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="doneLTF" class="col-sm-4 control-label">Done LTF</label>
                <div class="col-sm-7">
                    <input type="text" name="doneLTF" id="doneLTF" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="goalRMF" class="col-sm-4 control-label">Goal RMF/Year</label>
                <div class="col-sm-7">
                    <input type="text" name="goalRMF" id="goalRMF" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="doneRMF" class="col-sm-4 control-label">Done RMF</label>
                <div class="col-sm-7">
                    <input type="text" name="doneRMF" id="doneRMF" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="openSignature" class="col-sm-4 control-label">ใบเปิดบัญชีที่เซ็นแล้ว</label>
                <div class="col-sm-7">
                    <input type="text" name="openSignature" id="openSignature" class="form-control">
                </div>
            </div>

            <div class="form-group">
                <label for="openSignature" class="col-sm-4 control-label">บัญชีธนาคารที่ผูก</label>
                <div class="col-sm-7">
                    <input type="text" name="bankcus" id="openSignature" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="Bagged" id="Bagged" class="form-control">
                </div>
            </div>
            <div class="form-group">
