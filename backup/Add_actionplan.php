 ...
 font-size: 12px;
	...
	<body class="loading-overlay-showing" data-loading-overlay>
		...
		<section class="body">
							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Action Plan : <?=$cus_perface?><?=$rowu['cus_name']?> <?=$rowu['cus_lastname']?></h2>
									</header>
									<div class="panel-body">
										<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="Action-plan-<?=$customer_id?>" class="btn btn-danger" onclick="clicksound.playclip()">black <i class="fa fa-reply"></i></a>
			...
			<form class="form-horizontal" novalidate="novalidate" action="server/action.php" method="post" enctype="multipart/form-data" name="product" >		
            ...
            <div class="col-md-6">
            	...
            	<div class="form-group">
                        <label for="todo" class="col-sm-4 control-label">สิ่งที่ต้องทำ</label>
                        <div class="col-sm-7">
