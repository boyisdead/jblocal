...
<html class="fixed">
	<head>
		...
		<meta name="description" content="ประกันชีวิต">
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">รายชื่อลูกค้า ประกันชีวิต</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="Add_insurance" class="btn btn-primary" onclick="clicksound.playclip()">Add <i class="fa fa-plus"></i></a>
										</div>
									</div>
								</div>
...
//เลือกข้อมูล
$sql="SELECT * FROM insurance WHERE member_id = $iduser ORDER BY insurance.id ASC LIMIT $start_record, $page_size";
$result=mysql_query($sql)or die(mysql_error());
...
$ins_nameCompany = $row['ins_nameCompany'];
...
?>
										...
										<td><?=$row['ins_moneyPay']?></td>  
										<td><?=$my_formats2?> <?=$my_formats1?> <?=$my_formats?></td>
											<td class="actions">
												<a href="cus_insurance-<?=$row['customer_id']?>-<?=$row['id']?>" onclick="clicksound.playclip()" style="font-size: 16px;" class="on-default "><i class="fa fa-play-circle"></i></a>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/INDelete.php?id=<?=$row['id']?>">Confirm</a>
