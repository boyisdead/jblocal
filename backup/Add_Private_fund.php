...
<html class="fixed">
	<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Add Private Fund</title>
		<meta name="keywords" content="HTML5 AAdd Private Fund" />
		<meta name="description" content="Add Private Fund">
							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add New Private Fund</h2>
									</header>
									<div class="panel-body">
										
						
										
			<form class="form-horizontal" novalidate="novalidate" action="server/insert_PF.php" method="post" enctype="multipart/form-data" name="product" >		
...
<input name="meid" type="hidden" id="id" value="<?=$iduser?>"/>
            ...
            <div class="form-group">
                <label for="broker" class="col-sm-4 control-label">ชื่อบริษัทหลักทรัพย์</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label for="startDate" class="col-sm-4 control-label">วันที่เริ่มลงทุน</label>
                <div class="col-sm-7">
                    <div class="input-group date">
                        <input id="birthday" name="startDate" class="form-control" type="text">
            ...
            <div class="form-group">
                <label for="startMoney" class="col-sm-4 control-label">จำนวนเงินลงทุนเริ่มต้น (บาท)</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea name="banklink" id="banklink" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="style" class="col-sm-4 control-label">ลักษณะการลงทุน</label>
                <div class="col-sm-7">
                    <textarea name="style" id="style" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group">
