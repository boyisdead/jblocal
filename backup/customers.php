					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Customer:รายชื่อลูกค้า</h2>
							</header>
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="Addcustomer" class="btn btn-primary" onclick="clicksound.playclip()">Add <i class="fa fa-plus"></i></a>
										</div>
									</div>
								</div>
...
//เลือกข้อมูล
$sql="SELECT * FROM customer WHERE member_id = $iduser ORDER BY customer.id ASC LIMIT $start_record, $page_size";
$result=mysql_query($sql)or die(mysql_error());
