...
$sql="SELECT * FROM insurance_al WHERE inal_nameCompany = '$companyName3' AND inal_type = '$type3' AND member_id = $iduser ORDER BY id ASC ";
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance_al WHERE inal_nameCompany = '$companyName3' AND member_id = $iduser ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance_al WHERE member_id = $iduser ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
