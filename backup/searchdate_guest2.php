...
$sql="SELECT * FROM insurance_al WHERE inal_nameCompany = '$companyName3' AND inal_type = '$type3' AND member_id = $guest_id AND (DATE_FORMAT(inal_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance_al WHERE inal_nameCompany = '$companyName3' AND member_id = $guest_id AND (DATE_FORMAT(inal_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance_al WHERE inal_type = '$type3' AND member_id = $guest_id AND (DATE_FORMAT(inal_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance_al WHERE member_id = $guest_id AND (DATE_FORMAT(inal_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance WHERE ins_nameCompany = '$companyName2' AND ins_nameType = '$type2' AND member_id = $guest_id AND (DATE_FORMAT(ins_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance WHERE ins_nameCompany = '$companyName2' AND member_id = $guest_id AND (DATE_FORMAT(ins_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM insurance WHERE member_id = $guest_id AND (DATE_FORMAT(ins_deal,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM product_aboard WHERE company = '$companyName1' AND product = '$type1' AND member_id = $guest_id AND (DATE_FORMAT(pa_pay_date,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM product_aboard WHERE company = '$companyName1' AND member_id = $guest_id AND (DATE_FORMAT(pa_pay_date,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
//เลือกข้อมูล
//$sql="SELECT * FROM customer WHERE customer_id = 6 ORDER BY id DESC ";
$sql="SELECT * FROM product_aboard WHERE member_id = $guest_id AND (DATE_FORMAT(pa_pay_date,'%m-%d') BETWEEN '$startDate' AND '$endDate') ORDER BY id ASC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
$sql="SELECT * FROM customer WHERE (DATE_FORMAT(cus_birthday,'%m-%d') BETWEEN '$startDate2' AND '$endDate2') AND (member_id= $guest_id) AND (($my_formaty-(DATE_FORMAT(cus_birthday,'%Y'))) BETWEEN '$oldstart' AND '$oldend') $sex1 $carrier1 ORDER BY id DESC ";
//echo $sql;
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
<?php
       ...
       if($oldstart!="" && $oldend!="" && $sex=="" && $carrier==""){
       	$sql="SELECT * FROM customer WHERE (DATE_FORMAT(NOW(),'%Y')-DATE_FORMAT(cus_birthday,'%Y')) BETWEEN $oldstart AND $oldend AND (member_id= $guest_id)  ORDER BY id DESC ";
       ...
       $sql="SELECT * FROM customer WHERE ((DATE_FORMAT(NOW(),'%Y')-DATE_FORMAT(cus_birthday,'%Y')) BETWEEN $oldstart AND $oldend) AND (cus_sex = $sex) AND (member_id= $guest_id)  ORDER BY id DESC ";
       } else if($oldstart!="" && $oldend!="" && $sex=="" && $carrier!=""){
       	$sql="SELECT * FROM customer WHERE ((DATE_FORMAT(NOW(),'%Y')-DATE_FORMAT(cus_birthday,'%Y')) BETWEEN $oldstart AND $oldend) AND (cus_carrier LIKE '%$carrier%') AND (member_id= $guest_id)  ORDER BY id DESC ";
       } else if($oldstart=="" && $oldend=="" && $sex!="" && $carrier!=""){
       	$sql="SELECT * FROM customer WHERE (cus_sex = $sex) AND (cus_carrier LIKE '%$carrier%')  ORDER BY id DESC ";
       } else if($oldstart!="" && $oldend!="" && $sex!="" && $carrier!=""){
       	$sql="SELECT * FROM customer WHERE ((DATE_FORMAT(NOW(),'%Y')-DATE_FORMAT(cus_birthday,'%Y')) BETWEEN $oldstart AND $oldend) AND (cus_carrier LIKE '%$carrier%') AND (cus_sex = $sex) AND (member_id= $guest_id)  ORDER BY id DESC ";
       } else {
       		echo"<script>alert('ท่านใส่ข้อมูลไม่ครบนะครับ');window.location='searchdate_guest';</script>";exit;
       }
...
$sql="SELECT customer.id AS customer_id, customer.cus_perface AS customer_cus_perface, customer.cus_name AS cus_name, customer.cus_lastname AS cus_lastname, customer.cus_types AS cus_type, insurance_al.inal_type AS inal_type FROM customer RIGHT JOIN insurance_al ON insurance_al.customer_id=customer.id WHERE (insurance_al.inal_type = '$type') AND (customer.member_id= $guest_id) ORDER BY insurance_al.id DESC ";
$result=mysql_query($sql)or die(mysql_error());
for($i=0;$row=mysql_fetch_assoc($result);$i++){ 
...
?>	
        ...
        break;               
    default:
        echo"<script>alert('ท่านใส่ข้อมูลไม่ครบ');window.location='searchdate_guest';</script>";exit;
}	
?>
...
<div class="form-group">
                <label for="guest_id" class="col-sm-4 control-label">เลือกชื่อ Guest</label>
                <div class="col-sm-7">
                    <select name="guest_id" id="guest_id" class="form-control" required="">
                        <option value="">-- โปรดเลือก --</option>
                        <?php
                        $sqlcus="SELECT * FROM user WHERE guest_id = $iduser ORDER BY id ASC ";
						$resultcus=mysql_query($sqlcus)or die(mysql_error());
						for($icus=0;$rowcus=mysql_fetch_assoc($resultcus);$icus++){ 
						?>
                   		<option value="<?=$rowcus['id']?>"><?=$rowcus['First_Name']?> <?=$rowcus['Last_Name']?></option>
                   		<?php
                   		}
                   		?>
                    </select>
