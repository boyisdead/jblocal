...
$sql2="SELECT * FROM insurance WHERE customer_id = '$customer_id' AND id = '$id' ";
...
$ins_nameCompany = $row2['ins_nameCompany'];
...
$time1 = strtotime($row2['ins_startDate']);
    $my_format = date("Y", $time1);
    $my_format1 = date("F", $time1);
    $my_format2 = date("d", $time1);


    $time3 = strtotime($row2['endltDate']);
    $my_formate = date("Y", $time3);
    $my_formate1 = date("F", $time3);
    $my_formate2 = date("d", $time3);


        $time4 = strtotime($row2['ins_confirmPay']);
    $my_formatf = date("Y", $time4);
    $my_formatf1 = date("F", $time4);
    $my_formatf2 = date("d", $time4);


    $time2 = strtotime($row2['ins_deal']);
...
<html class="fixed">
	<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>ประกันภัยชีวิต</title>
		<meta name="keywords" content="ประกันภัยชีวิต" />
		<meta name="description" content="ประกันภัยชีวิต">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>ประกันภัยชีวิต</span></li>
					...
					<div class="row">
						<div class="col-md-4 col-lg-3">
							...
							$sqlMF="SELECT * from insurance WHERE customer_id=$customer_id ";
									...
									<div class="panel-body bg-info" style="margin-bottom:10px;">
										<div class="widget-summary widget-summary-sm">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4 class="title"><?=$rowMF['ins_nameCompany']?> ( <?=$rowMF['ins_nameType']?> ) <a href="#modalAnim<?=$rowMF['id']?>" class="modal-with-zoom-anim" onclick="clicksound.playclip()" style="font-size: 16px; float:right; color:#fff" ><i class="fa fa-trash-o"></i></a></h4>
													<div class="info">
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/INDelete.php?id=<?=$rowMF['id']?>">Confirm</a>
						...
						<div class="col-md-8 col-lg-6">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs tabs-primary">
									...
									<li class="">
										<a href="#pass" data-toggle="tab" aria-expanded="false">Edit insurance info</a>
									</li>
								</ul>
								<div class="tab-content">
									...
									<div id="edit" class="tab-pane active">
											...
											<h4 class="mb-xlg text-primary">Insurance <?=$numid?> : <?=$row['cus_name']?> <?=$row['cus_lastname']?></h4>
											...
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><?=$row2['ins_nameCompany']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><?=$row2['ins_type']?></label>
													</div>
												</div>


												<div class="form-group">
													<label class="col-md-5 control-label" ><b>Username Web Link :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$row2['ins_login']?></label>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-5 control-label" ><b>Password Web Login :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$row2['ins_pwd']?></label>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-5 control-label" ><b>แบบประกัน :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$row2['ins_nameType']?></label>
													</div>
												</div>


												<div class="form-group">
													<label class="col-md-5 control-label" ><b>อนุสัญญาเพิ่มเติม :</b></label>
													<div class="col-md-6">
														<label class="" ><?=$row2['ins_more']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><?=number_format($row2['ins_startMoney2'])?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b><code>วันที่จ่ายเบี้ยครั้งล่าสุด</code> :</b></label>
													<div class="col-md-6">
														<label class="" ><code><?=$my_formatf2?> <?=$my_formatf1?> <?=$my_formatf?></code></label>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><?=$my_formate2?> <?=$my_formate1?> <?=$my_formate?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="" ><code><?=$my_formats2?> <?=$my_formats1?> <?=$my_formats?></code></label>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-5 control-label" ><b><code>จำนวนเบี้ยที่จ่ายล่าสุด :</code></b></label>
													<div class="col-md-6">
														<label class="control-label" ><code><?=number_format($row2['ins_moneyPay'])?></code></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label"><b>ประเภทการจ่ายเงิน :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$ins_typePay?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b>ทุนประกันเริ่มต้น :</b></label>
													<div class="col-md-6">
														<label class="" ><?=number_format($row2['ins_startMoney'])?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['ins_whoRec']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['ins_status']?></label>
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-5 control-label"><b>ชื่อตัวแทนเจ้าของเคส :</b></label>
													<div class="col-md-6">
														<label class="control-label" ><?=$row2['ins_ownerCode']?></label>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-11 control-label"><b><code>*** Mark สีแดงต้องเปลี่ยนทุกปี</code></b></label>
									...
									<div id="pass" class="tab-pane">
											...
											<h4 class="mb-xlg">Insurance <?=$numid?> : <?=$row['cus_name']?> <?=$row['cus_lastname']?></h4>
...
<form class="form-horizontal" action="server/InsuranceUpdate.php" method="post" enctype="multipart/form-data" name="product" >
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="companyName" id="companyName" class="form-control">
                                <option value="<?=$row2['ins_nameCompany']?>"><?=$row2['ins_nameCompany']?></option>
                                <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="No" id="No" value="<?=$row2['ins_no']?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="type" id="type" class="form-control">
                                <option value="<?=$row2['ins_type']?>"><?=$row2['ins_type']?></option>
                                <?php
                        $sqlcus="SELECT * FROM product2 WHERE category_id = 7 ORDER BY id ASC ";
						$resultcus=mysql_query($sqlcus)or die(mysql_error());
						for($icus=0;$rowcus=mysql_fetch_assoc($resultcus);$icus++){ 
						?>
                   		<option value="<?=$rowcus['name']?>"><?=$rowcus['name']?></option>
                    ...
                    <div class="form-group">
                        <label for="username" class="col-sm-4 control-label">Username Web Link</label>
                        <div class="col-sm-7">
                            <input type="text" name="username" id="username" value="<?=$row2['ins_login']?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="password" class="col-sm-4 control-label">Password Web Login</label>
                        <div class="col-sm-7">
                            <input type="password" name="password" id="password" value="<?=$row2['ins_pwd']?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nameType" class="col-sm-4 control-label">แบบประกัน</label>
                        <div class="col-sm-7">
                          
                            <select name="nameType" id="nameType" class="form-control">
                                <option value="<?=$row2['ins_nameType']?>"><?=$row2['ins_nameType']?></option>
                                <?php
                    ...
                    <div class="form-group">
                        <label for="more" class="col-sm-4 control-label">อนุสัญญาเพิ่มเติม</label>
                        <div class="col-sm-7">
                            <input type="text" name="more" id="more" value="<?=$row2['ins_more']?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="startMoney2" class="col-sm-4 control-label">จำนวนเบี้ยเริ่มต้น</label>
                        <div class="col-sm-7">
                            <input type="text" name="startMoney2" value="<?=$row2['ins_startMoney2']?>" id="startMoney2" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="ins_confirmPay" class="col-sm-4 control-label"><code>วันที่จ่ายเบี้ยครั้งล่าสุด</code></label>
                        <div class="col-sm-7">
                            <div class="input-group date">
                                <input id="ins_confirmPay" name="ins_confirmPay" value="<?=$row2['ins_confirmPay']?>" class="form-control" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group date">
                                <input id="startDate" name="startDate" value="<?=$row2['ins_startDate']?>" class="form-control" type="text">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="endltDate" class="col-sm-4 control-label">วันที่ครบสัญญา</label>
                        <div class="col-sm-7">
                            <div class="input-group date">
                                <input id="endltDate" name="endltDate" value="<?=$row2['endltDate']?>" class="form-control" type="text">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group date">
                                <input id="dealDate" name="startDate1" value="<?=$row2['ins_deal']?>" class="form-control" type="text">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="moneyPay" value="<?=$row2['ins_moneyPay']?>" id="moneyPay" class="form-control">
                        </div>
                    </div>


                    <div class="form-group">
                        <label for="typePay" class="col-sm-4 control-label">ประเภทการจ่ายเงิน</label>
                        <div class="col-sm-7">
                            <select name="typePay" id="typePay" class="form-control">
                                <option value="<?=$row2['ins_typePay']?>"><?=$ins_typePay?></option>
                                <option value="1">ราย 1 เดือน</option>
                                <option value="2">ราย 3 เดือน</option>
                                <option value="3">ราย 6 เดือน</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="detailMoney" id="detailMoney" value="<?=$row2['detailMoney']?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="receiveMoney" id="receiveMoney" value="<?=$row2['receiveMoney']?>" class="form-control">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="startMoney" class="col-sm-4 control-label">ทุนประกันเริ่มต้น</label>
                        <div class="col-sm-7">
                            <input type="text" name="startMoney" value="<?=$row2['ins_startMoney']?>" id="startMoney" class="form-control">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="whoRec" id="whoRec" value="<?=$row2['ins_whoRec']?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="<?=$row2['ins_status']?>"><?=$row2['ins_status']?></option>
                                <?php
                    ...
                    <div class="form-group">
                        <label for="ownerCode" class="col-sm-4 control-label">ชื่อตัวแทนเจ้าของเคส</label>
                        <div class="col-sm-7">
                            <input type="text" name="ownerCode" id="ownerCode" value="<?=$row2['ins_ownerCode']?>" class="form-control">
                        </div>
                    </div>
