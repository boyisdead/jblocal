							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									...
									<div class="col-sm-6">
										...
										<input name="action" type="hidden" id="id" value="add_category"/>
...
?></td>
											...
											<td class="actions" style="font-size:15px;">
												...
												<a href="categoryProduct.php?id=<?=$row['id']?>" style="font-size: 16px;" class="on-default " onclick="clicksound.playclip()"><i class="fa fa-play-circle"></i></a>
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/super.php?id=<?=$row['id']?>&action=del_category">Confirm</a>
														<button class="btn btn-default modal-dismiss">Cancel</button>
													</div>
												</div>
											</footer>
									...
									<div id="modalAnim3<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										...
										<input name="action" type="hidden" id="id" value="update_category"/>
