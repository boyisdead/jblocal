 ...
 font-size: 12px;
	...
	<body class="loading-overlay-showing" data-loading-overlay>
		...
		<section class="body">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>เพิ่มกรมธรรม์ใหม่</span></li>
			...
			<form class="form-horizontal" novalidate="novalidate" action="server/insert_I.php" method="post" enctype="multipart/form-data" name="product" >		
            ...
            <div class="col-md-6">
                ...
                <div class="col-sm-7">
                   ...
                   <input type="text" name="cusID" id="cusID" value="<?=$customer_id?>" class="form-control hide" required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group date">
                                <input id="endltDate" name="endltDate" class="form-control" type="text">
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        <label for="dealDate" class="col-sm-4 control-label">วันที่ดิวเบี้ย</label>
                        <div class="col-sm-7">
                            <div class="input-group date">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="startMoney" id="startMoney" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="startMoney2" class="col-sm-4 control-label">จำนวนเบี้ยเริ่มต้น</label>
                        <div class="col-sm-7">
                            <input type="text" name="startMoney2" id="startMoney2" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="moneyPay" class="col-sm-4 control-label">จำนวนเบี้ยที่จ่ายต่องวด</label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <label for="howPay" class="col-sm-4 control-label">วิธีการจ่ายเบี้ย</label>
                        <div class="col-sm-7">
                            <select name="howPay" id="howPay" class="form-control">
                                <option value="">-- โปรดเลือก --</option>
                                <option value="1">เงินสด</option>
                                <option value="2">หักบัญชีธนาคาร</option>
                                <option value="3">ตัดบัตรเครดิต</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="confirmPay" class="col-sm-4 control-label">จ่ายเบี้ยแล้ว ปีนี้</label>
                        <div class="col-sm-7">
                            <select name="confirmPay" id="confirmPay" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select name="status" id="status" class="form-control">
                                <option value="0">ไม่มีผลบังคับ</option>
                                <option value="1">มีผลบังคับ</option>
                                <option value="2">จ่ายครบสัญญาแล้ว</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ownerCode" class="col-sm-4 control-label">ชื่อตัวแทนเจ้าของโค้ด</label>
                        <div class="col-sm-7">
                            <input type="text" name="ownerCode" id="ownerCode" class="form-control">
                        </div>
                    </div>
