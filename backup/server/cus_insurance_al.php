									...
									<div class="panel-body bg-warning" style="margin-bottom:10px;">
										<div class="widget-summary widget-summary-sm">
											...
											<div class="widget-summary-col">
												<div class="summary">
													<h4 class="title"><?=$rowMF['inal_nameCompany']?> ( <?=$i+1?> )</h4>
													<div class="info">
								...
								<div class="tab-content">
									...
									<div id="edit" class="tab-pane active">
											...
											<fieldset>
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b>จำนวนเบี้ยที่จ่ายล่าสุด :</b></label>
													<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-5 control-label" ><b>วันที่จ่ายเบี้ยครั้งล่าสุด :</b></label>
													<div class="col-md-6">
...
<form class="form-horizontal" action="server/InsurancealUpdate.php" method="post" enctype="multipart/form-data" name="product" >
	...
	<input name="cus_id" type="hidden" id="id" value="<?=$customer_id?>"/>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="moneyPay" class="col-sm-4 control-label">จำนวนเบี้ยที่จ่ายล่าสุด</label>
                        <div class="col-sm-7">
...
<!--   ///////////////////////////////           -->
                    ...
                    <div class="form-group">
                        <label for="confirmPay" class="col-sm-4 control-label">วันที่จ่ายเบี้ยครั้งล่าสุด</label>
                        <div class="col-sm-7">
                            <div class="input-group date">
