					...
					<div class="row">
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									...
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="super_all_category" class="btn btn-danger" onclick="clicksound.playclip()">black <i class="fa fa-reply"></i></a>
										...
										<input name="action" type="hidden" id="id" value="add_product2"/>
...
<?php
$sql="SELECT * FROM product2 WHERE category_id = $category_id ";
...
<div id="modalAnim<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														...
														<a class="btn btn-primary " onclick="clicksound.playclip()" href="server/super.php?product_id=<?=$row['id']?>&action=del_product2">Confirm</a>
														<button class="btn btn-default modal-dismiss">Cancel</button>
													</div>
												</div>
											</footer>
									...
									<div id="modalAnim3<?=$row['id']?>" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										...
										<input name="action" type="hidden" id="id" value="update_product2"/>
										<input name="category_id" type="hidden" id="id" value="<?=$category_id?>"/>
