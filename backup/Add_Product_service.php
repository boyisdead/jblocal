							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">ADD OFFSHORE PRODUCT</h2>
									</header>
...
<input name="meid" type="hidden" id="id" value="<?=$iduser?>"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                	<input type="text" name="money_to_m" id="money_to_m" class="form-control">
			...
			<div class="form-group">
                <label for="last_money_to_m" class="col-sm-4 control-label"><code>จำนวนเบี้ยที่จ่ายล่าสุด (บาท)</code></label>
                <div class="col-sm-7">
                	<input type="text" name="last_money_to_m" id="last_money_to_m" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group date">
                        <input id="birthday" name="date_for_start" class="form-control" type="text">
  ...
  <!-- ////////////////////////////////////////////////////// //////////////////////////////////////////////////////////////////////////  ////////////////// -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="input-group date">
                        <input id="birthday" name="endl_date_service" class="form-control" type="text">
                        <span class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                        </span>
                    </div>
            ...
            <div class="form-group">
                <label for="startDate" class="col-sm-4 control-label"><code>วันที่ดิวเบี้ย</code></label>
                <div class="col-sm-7">
                    <div class="input-group date">
            ...
            <div class="form-group">
                <label for="last_money" class="col-sm-4 control-label"><code>วันที่จ่ายเบี้ยล่าสุด</code></label>
                <div class="col-sm-7">
                    <div class="input-group date">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                	<input type="text" name="detail_for_bear" id="detail_for_bear" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                	<input type="text" name="detail_for_recive" id="detail_for_recive" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                	<input type="text" name="total_money_reverse" id="startMoney" class="form-control">
