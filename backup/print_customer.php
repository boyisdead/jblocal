...
<html class="fixed">
	<head>
		...
		<title>แผ่นสรุปลูกค้า</title>
		<meta name="keywords" content="แผ่นสรุปลูกค้า" />
		<meta name="description" content="แผ่นสรุปลูกค้า">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><a href="Action-plan-<?=$customer_id?>"><span>Customer</span></a></li>
								<li><span>แผ่นสรุปลูกค้า</span></li>
							</ol>
								...
								<header class="clearfix">
									<div class="row">
										<div class="col-sm-6 mt-md">
											<h2 class="h2 mt-none mb-sm text-dark text-weight-bold">แผ่นสรุปลูกค้า</h2>
											<h4 class="h4 m-none text-dark text-weight-bold">#<?=$rowc['id']?></h4>
										</div>
