...
$sql1="SELECT * FROM compose WHERE id = $id ";
...
<html class="fixed">
	<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Edit Compose Mail</title>
		<meta name="keywords" content="Edit Compose Mail" />
		<meta name="description" content="Edit Compose Mail">
		...
		<!-- Theme CSS -->
		<link rel="stylesheet" href="assets/stylesheets/theme89.css" />
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Edit Compose Mail</span></li>
							...
							<div class="col-xs-12">
								<section class="panel form-wizard" id="w4">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Edit Compose Mail</h2>
									</header>
									<div class="panel-body">
										
						
										
			<form class="form-horizontal" novalidate="novalidate" action="process/compose/productUpdate.php" method="post" enctype="multipart/form-data" name="product" >		
...
<input name="id" type="hidden" id="id" value="<?=$row1['id']?>"/>
          ...
          <label class="col-sm-2 control-label" for="user_email">Enter mail subject.</label>
           <div class="col-sm-10">
            <span class="typeahead-query">
                <input  type="text" class="form-control" id="subject" name="subject" value="<?=$row1['subject']?>">
            </span>
          </div>
        </div>
...
<hr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                	<div class="compose">
                    <div id="summernote"><?=$row1['detail']?></div>

                    <textarea id="lawsContent" name="detail" class="form-control hide"><?=$row1['detail']?></textarea>
                </div>
                </div>
            </div>
...
<div class="col-sm-2">
            ...
            <div class="table-responsive">
											<table class="table mb-none">
												...
												<tbody>
						<?php
                        $sqlc="SELECT * FROM job_compose WHERE compose_id = $row1[id]";
						$resultc=mysql_query($sqlc)or die(mysql_error());
						for($i=0;$rowc=mysql_fetch_assoc($resultc);$i++){ 
						...
						?>
													<tr>
														...
														<td><?=$row5['title']?></td>
														<td><?=$rowc1['name']?></td>
														<td><a href="process/compose/compose_job_Delete.php?id=<?=$rowc['id']?>" style="font-size: 16px;" onclick="clicksound.playclip()"><i class="fa fa-trash-o"></i></a></td>
													</tr>
            ...
            <div class="form-group">
                <label for="no" class="col-sm-2 control-label">Add new Job id</label>
                <div class="col-sm-10">
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-info" onclick="clicksound.playclip()"><i class="fa fa-save"></i> subit</button>
