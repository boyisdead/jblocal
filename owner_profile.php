						...
						<div class="col-md-8 col-lg-8">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs tabs-primary">
									...
									<li class="">
										<a href="#pass" data-toggle="tab" aria-expanded="false">Edit <?=$row['First_Name']?> <?=$row['Last_Name']?> info</a>
									</li>
...
.control-label{
	    text-align: right;
									...
									<div id="pass" class="tab-pane">
											...
											<form class="form-horizontal" action="process/owner/ownerUpdate.php" method="post" enctype="multipart/form-data" name="product" >
											<h4 class="mb-xlg">Edit <?=$row['First_Name']?> <?=$row['Last_Name']?> Information</h4>
											...
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														...
														<input type="text" name="id" class="form-control hide" value="<?=base64_encode($row['id'])?>" >
														<input type="text" name="Owner" class="form-control hide" value="<?=$iduser?>" >
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<textarea class="form-control" name="Company" rows="2"><?=$row['Company']?></textarea>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														...
														<textarea class="form-control" name="Title" rows="3"><?=$row['Title']?></textarea>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-3 control-label" >Class_1  :</label>
													<div class="col-md-8">
														<input type="text" name="Class_1" class="form-control" value="<?=$row['Class_1']?>"  >
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-3 control-label" >Class_2  :</label>
													<div class="col-md-8">
														<input type="text" name="Class_2" class="form-control" value="<?=$row['Class_2']?>"  >
													</div>
												</div>

												<div class="form-group">
													<label class="col-md-3 control-label" >Class_3  :</label>
													<div class="col-md-8">
														<input type="text" name="Class_3" class="form-control" value="<?=$row['Class_3']?>"  >
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-3 control-label" >Yrs_Exp  :</label>
													<div class="col-md-8">
														<input type="text" name="Yrs_Exp" class="form-control" value="<?=$row['Yrs_Exp']?>"  >
													</div>
												</div>
