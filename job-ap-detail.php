...
$sql4="SELECT * FROM submit_job WHERE id = $id ";
...
$sql5="SELECT * FROM candidate_profile WHERE oauth_uid = '$row4[user_id]'";
							...
							<div class="tabs tabs-primary">
								...
								<div class="tab-content">
									...
									<div id="edit" class="tab-pane active">
											<h4 class="mb-xlg text-primary"><b>Job Apply #ID : <?=$row4['id']?> </b> <a href="#modalAnim3" type="button" class="modal-with-zoom-anim mb-xs mt-xs mr-xs btn btn-primary"><i class="fa fa-plus"></i> New Job</a></h4>
											<hr>
...
<div id="modalAnim3" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
										<form id="demo-form2" class="form-horizontal mb-lg"  action="process/shipping/shippingInsert4.php" method="post" enctype="multipart/form-data">
										<section class="panel">
									...
									<div id="showalert1"></div>
											...
											<input name="user_id" type="hidden" id="id" value="<?=$row5['oauth_uid']?>"/>
			...
			<div class="form-group">
                ...
                <div class="col-sm-7">
                	<select multiple data-plugin-selectTwo name="id" id="jobid" class="form-control populate" required="">
            ...
            <div class="form-group">
								                        ...
								                        <div class="col-sm-7">
								                           <textarea class="form-control" name="comment" rows="3" id="textareaDefault"></textarea>
								                        </div>
								                    </div>
...
<form class="form-horizontal" action="process/bank/bankUpdate.php" method="post" enctype="multipart/form-data" name="product" >
...
<!-- P2 -->
						...
						<div class="col-lg-9">
							<form action="process/bank/commentUpdate.php" method="post" enctype="multipart/form-data">
								<section class="panel">
									<header class="panel-heading">
